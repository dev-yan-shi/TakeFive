  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        <Text style={styles.title}>Liner Notes</Text>
        <Text style={styles.subtitle}>{formatDateDisplay(selectedDate)} · reviewing the record</Text>
      </View>
          ...
          <>
            ...
            <View style={styles.card}>
              <View style={styles.cardTitleRow}>
                <Text style={styles.cardTitle}>The Bandleader's Review</Text>
                <Text style={styles.aiChip}>AI</Text>
              </View>
                ...
                >
                  {isGeneratingInsight ? (
                    <View style={styles.generatingRow}>
                      ...
                      <Text style={styles.generatingText}>Reviewing the record...</Text>
                    </View>
                  ) : (
                    <View style={styles.generateBtnContent}>
                      ...
                      <View>
                        ...
                        <Text style={styles.generateBtnHint}>
                          Liner notes from your bandleader
                        </Text>
                      </View>
                    </View>
                  )}
            ...
            {/* Category Breakdown */}
            <View style={styles.card}>
              <Text style={styles.cardTitle}>Time by Key</Text>
              {stats.categoryStats.length === 0 ? (
                <Text style={styles.emptyText}>Nothing on the setlist yet. Start composing!</Text>
              ) : (
            ...
            {/* Eisenhower Matrix */}
            <View style={styles.card}>
              <Text style={styles.cardTitle}>The Four Quadrants</Text>
          ...
          <>
            ...
            {!weeklyLoaded ? (
              ...
              <>
                {/* Week Overview */}
                <View style={styles.card}>
                  <Text style={styles.cardTitle}>Album Overview</Text>
                ...
                <View style={styles.card}>
                  ...
                  <Text style={styles.cardSubtitle}>Hours composed per day, by Key</Text>
                  <WeeklyChart stats={weeklyStats} />
                </View>

                {/* Top Categories for the week */}
                <View style={styles.card}>
                  <Text style={styles.cardTitle}>Headliners This Week</Text>
...
const styles = StyleSheet.create({
  ...
  title: { color: APP_COLORS.text, fontSize: 26, fontFamily: FONTS.heading, letterSpacing: -0.3 },
  subtitle: { color: APP_COLORS.textSecondary, fontSize: 13, fontFamily: FONTS.body, marginTop: 2, fontStyle: 'italic', letterSpacing: 0.3 },
  ...
  cardTitle: { color: APP_COLORS.text, fontSize: 18, fontFamily: FONTS.heading, marginBottom: 4, letterSpacing: -0.2 },
  cardTitleRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  cardSubtitle: { color: APP_COLORS.textMuted, fontSize: 12, fontFamily: FONTS.body, marginBottom: 12, fontStyle: 'italic' },
  emptyText: {
