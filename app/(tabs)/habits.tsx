...
import { APP_COLORS, CATEGORY_COLORS, FONTS } from '../../src/constants/colors';
      ...
      <View style={styles.header}>
        <View style={styles.headerRow}>
          <View>
            ...
            <Text style={styles.subtitle}>{formatDateDisplay(selectedDate)} · daily practice</Text>
          </View>
        ...
        {dueHabits.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>
              Like jazz standards, these are the daily pieces you practice. Link one to a Key for auto-completion.
            </Text>
            <TouchableOpacity style={styles.emptyBtn} onPress={() => setShowAddModal(true)}>
              <Text style={styles.emptyBtnText}>Add First Standard</Text>
            </TouchableOpacity>
          </View>
        ) : (
          dueHabits.map((habit) => {
    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={onClose}>
        <TouchableOpacity activeOpacity={1} style={styles.modalContent}>
          ...
          <Text style={styles.modalLabel}>Auto-complete with a Key (optional)</Text>
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          ...
          <View style={styles.modalBtnRow}>
            ...
            <TouchableOpacity style={styles.modalSaveBtn} onPress={handleSave}>
              <Text style={styles.modalSaveText}>Add Standard</Text>
            </TouchableOpacity>
          </View>
        </TouchableOpacity>
      </TouchableOpacity>
