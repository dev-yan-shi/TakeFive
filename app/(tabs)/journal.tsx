      ...
      >
        ...
        <View style={styles.tabRow}>
          <TouchableOpacity
            ...
            onPress={() => { play('tap'); setActiveTab('morning'); }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => { play('tap'); setActiveTab('evening'); }}
          >
            <Text style={styles.tabIcon}>🥃</Text>
          ...
          {activeTab === 'morning' ? (
            <>
              ...
              <View style={styles.card}>
                <Text style={styles.cardTitle}>Tonight's Setlist</Text>
                <Text style={styles.cardHint}>What are we playing today? Set your intentions.</Text>
              ...
              >
                <Text style={styles.saveBtnText}>
                  {getMorning() ? 'Update Soundcheck' : 'Lock in Soundcheck'}
                </Text>
              </TouchableOpacity>
            ...
            <>
              ...
              >
                <Text style={styles.saveBtnText}>
                  {getEvening() ? 'Update After Hours' : 'Save After Hours'}
                </Text>
              </TouchableOpacity>

              {getEvening() && (
                <View style={styles.savedBadge}>
                  <Text style={styles.savedBadgeText}>✓ After Hours logged</Text>
                </View>
              )}
              ...
              <View style={[styles.card, { marginTop: 16 }]}>
                <View style={styles.aiHeaderRow}>
                  <Text style={styles.cardTitle}>The Bandleader's Notes</Text>
                  <Text style={styles.aiChip}>AI</Text>
                </View>
                <Text style={styles.cardHint}>
                  Studio notes from your bandleader — weaves your setlist, wins, and the day's music together.
                </Text>
                  ...
                  >
                    {isGeneratingReflection ? (
                      <View style={styles.generatingRow}>
                        ...
                        <Text style={styles.generatingText}>Listening to your day...</Text>
                      </View>
                    ) : (
                      <View style={styles.generateContent}>
                        <Text style={styles.generateIcon}>🎷</Text>
                        <Text style={styles.generateText}>
                          {hasKey === false ? 'API key required' : 'Ask the Bandleader'}
                        </Text>
                      </View>
                    )}
                  </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  subtitle: { color: APP_COLORS.textSecondary, fontSize: 13, fontFamily: FONTS.body, marginTop: 2, letterSpacing: 0.3 },
  ...
  cardHint: { color: APP_COLORS.textMuted, fontSize: 13, fontFamily: FONTS.body, marginBottom: 14, lineHeight: 19, fontStyle: 'italic' },
